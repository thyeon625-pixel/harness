...
Derived from Harness-100 `36-design-system` as a Designer_Univers-specific scaffold. This is not a direct import.

## Purpose

design tokens, pattern language, component principles, and documentation.
