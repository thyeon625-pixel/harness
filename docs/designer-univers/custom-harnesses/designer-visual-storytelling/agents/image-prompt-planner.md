...
Plan image prompts/specs and visual motifs without invoking paid image generation by default.
...
Write `workspace/03_image_prompt_plan.md` with prompt directions, motif consistency, and generation approval notes.
