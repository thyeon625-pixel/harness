...
Draft design-system documentation outline, adoption notes, do/don’t examples, and glossary.
...
Write `workspace/04_documentation_outline.md` with docs structure and example sections.
