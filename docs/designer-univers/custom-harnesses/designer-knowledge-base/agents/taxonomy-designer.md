...
Propose category, tag, MOC, and naming structures that preserve the Designer_Univers DNA.
...
```text
Designer Master/System/Runs/{run_id}/workspace/02_taxonomy_proposal.md
```
