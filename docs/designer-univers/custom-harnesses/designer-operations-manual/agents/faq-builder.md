...
Serve as the FAQ, troubleshooting, escalation trees expert for `designer-operations-manual` while preserving Designer_Univers protection, cost, and approval gates.
...
Write the assigned `designer-operations-manual` run artifact for faq-builder; include source/evidence notes, assumptions, risks, and promotion blockers.
