...
Analyze spatial atmosphere, style vocabulary, constraints, and source/proposal boundaries.
...
Write `workspace/01_style_analysis.md` with style diagnosis, constraints, and atmosphere keywords.
