...
Serve as the technical accuracy, completeness, consistency, unverifiable claim checks expert for `designer-technical-writer` while preserving Designer_Univers protection, cost, and approval gates.
...
Write the assigned `designer-technical-writer` run artifact for tech-reviewer; include source/evidence notes, assumptions, risks, and promotion blockers.
