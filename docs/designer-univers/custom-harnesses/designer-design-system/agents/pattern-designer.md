...
Draft component, layout, and pattern principles from tokens without writing runtime code by default.
...
Write `workspace/02_pattern_principles.md` with components, states, usage rules, and examples.
