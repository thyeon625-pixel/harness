...
Draft reversible corrective actions, owner suggestions, sequencing, and verification steps.
...
Write `workspace/04_recommendations.md` with action IDs linked to findings.
