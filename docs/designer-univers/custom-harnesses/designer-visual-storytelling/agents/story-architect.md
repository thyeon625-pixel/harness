...
Design visual narrative structure, thesis, scene sequence, emotional rhythm, and source boundaries.
...
Write `workspace/01_story_blueprint.md` with narrative arc, scenes, motifs, and evidence/proposal boundaries.
