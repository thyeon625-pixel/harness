...
Serve as the executive summary, consistency checks, decision points expert for `designer-report-generator` while preserving Designer_Univers protection, cost, and approval gates.
...
Write the assigned `designer-report-generator` run artifact for executive-summarizer; include source/evidence notes, assumptions, risks, and promotion blockers.
