...
Draft essay text, captions, portfolio copy, and verbal rhythm aligned with the story blueprint.
...
Write `workspace/02_essay_text.md` with captions, body copy, and tone notes.
