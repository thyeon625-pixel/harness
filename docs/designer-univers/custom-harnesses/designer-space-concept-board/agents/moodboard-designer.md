...
Draft color, material, texture, light, and composition directions for a spatial moodboard.
...
Write `workspace/02_moodboard_direction.md` with palette, materials, textures, light, and layout concepts.
