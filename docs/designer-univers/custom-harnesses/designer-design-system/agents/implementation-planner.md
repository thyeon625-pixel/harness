...
Plan optional code/storybook implementation only when software scope is separately approved.
...
Write `workspace/05_implementation_plan.md` with code scope, prerequisites, risks, and approval gates.
