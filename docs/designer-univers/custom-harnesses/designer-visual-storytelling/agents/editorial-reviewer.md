...
Review coherence, evidence/proposal separation, tone, and readiness for safety review.
...
Write `review/05_editorial_review.md` with pass/fail, tensions, and required revisions.
