...
Serve as the turn collected data into trends, findings, and implications expert for `designer-report-generator` while preserving Designer_Univers protection, cost, and approval gates.
...
Write the assigned `designer-report-generator` run artifact for analysis-synthesizer; include source/evidence notes, assumptions, risks, and promotion blockers.
