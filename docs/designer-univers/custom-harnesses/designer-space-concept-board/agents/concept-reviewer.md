...
Review spatial concept coherence, feasibility, source/proposal separation, and safety readiness.
...
Write `review/05_concept_review.md` with pass/fail, tensions, and required revisions.
