...
Inventory Designer_Univers knowledge sources and existing analysis artifacts without changing them.
...
```text
Designer Master/System/Runs/{run_id}/workspace/01_knowledge_inventory.md
```
