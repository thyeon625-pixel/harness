...
Draft color, typography, spacing, radius, elevation, and motion token directions as proposals.
...
Write `workspace/01_token_direction.md` with token taxonomy, values/ranges, rationale, and non-goals.
