...
Serve as the audience analysis, information architecture, outline expert for `designer-technical-writer` while preserving Designer_Univers protection, cost, and approval gates.
...
Write the assigned `designer-technical-writer` run artifact for info-architect; include source/evidence notes, assumptions, risks, and promotion blockers.
