...
Define lifecycle, ownership, review cadence, and quality checks for the knowledge base.
...
```text
Designer Master/System/Runs/{run_id}/workspace/05_maintenance_plan.md
```
