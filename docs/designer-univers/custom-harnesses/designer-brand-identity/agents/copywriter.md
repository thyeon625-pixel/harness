...
Draft slogans, tone, verbal identity, story variants, and copy examples aligned with strategy.
...
Write `workspace/03_verbal_identity.md` with slogans, tone rules, story, example copy, and taboo phrases.
