...
Convert audit scope into concrete checks, expected evidence, and pass/fail criteria.
...
Write `workspace/02_audit_checklist.md` with check ID, criterion, evidence path, method, and risk if failed.
