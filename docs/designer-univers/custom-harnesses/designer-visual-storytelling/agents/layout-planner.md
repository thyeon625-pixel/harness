...
Plan page hierarchy, image/text sequencing, and layout rhythm without building a production app by default.
...
Write `workspace/04_layout_plan.md` with sections, ratios, layout patterns, and implementation notes.
