...
Serve as the full report structure and prose expert for `designer-report-generator` while preserving Designer_Univers protection, cost, and approval gates.
...
Write the assigned `designer-report-generator` run artifact for report-writer; include source/evidence notes, assumptions, risks, and promotion blockers.
