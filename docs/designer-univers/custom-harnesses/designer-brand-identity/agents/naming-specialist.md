...
Generate and evaluate naming directions while marking trademark/domain checks as user verification items.
...
Write `workspace/02_naming_candidates.md` with candidates, rationale, risks, and verification needs.
