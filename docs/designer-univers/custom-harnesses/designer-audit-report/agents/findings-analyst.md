...
Classify observations into findings with severity, evidence confidence, root cause, and impact.
...
Write `workspace/03_findings.md` with finding IDs, evidence, severity, root cause, and impact.
