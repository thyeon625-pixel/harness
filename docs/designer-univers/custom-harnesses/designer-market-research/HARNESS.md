...
Derived from Harness-100 `44-market-research` as a Designer_Univers-specific scaffold. This is not a direct import.

## Purpose

Research World trend analysis, competitor scanning, and external evidence reports.
