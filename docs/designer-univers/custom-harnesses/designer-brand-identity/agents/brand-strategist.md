...
Draft positioning, audience, archetype, promise, boundaries, and competitive frame for a design brand task.
...
Write `workspace/01_brand_strategy.md` with positioning, audience, promise, archetype, and non-goals.
