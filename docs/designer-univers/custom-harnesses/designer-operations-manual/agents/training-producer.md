...
Serve as the training outline, quizzes, practice tasks, onboarding summary expert for `designer-operations-manual` while preserving Designer_Univers protection, cost, and approval gates.
...
Write the assigned `designer-operations-manual` run artifact for training-producer; include source/evidence notes, assumptions, risks, and promotion blockers.
