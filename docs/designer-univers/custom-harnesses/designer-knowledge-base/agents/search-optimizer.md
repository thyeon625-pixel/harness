...
Design aliases, link maps, and search/index metadata for Obsidian-friendly retrieval.
...
```text
Designer Master/System/Runs/{run_id}/workspace/04_search_index_proposal.md
```
