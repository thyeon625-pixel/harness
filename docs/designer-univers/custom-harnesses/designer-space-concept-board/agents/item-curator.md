...
tool_policy: read only synthetic/project-approved references; write only under Designer Master/System/Runs/{run_id}; no purchase, checkout, account access, raw upload, or external shopping action
---
...
Suggest object/furniture/reference candidates as inspiration only; no purchasing or account access.
...
Write `workspace/03_item_candidates.md` with categories, candidate types, rationale, and uncertainty notes.
